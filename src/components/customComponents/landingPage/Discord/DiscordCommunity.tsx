...
export default function DiscordCommunity() {
  ...
  <div className="bg-[#ff0000] overflow-x-hidden">
    ...
    <Image
      ...
      width={300}
      height={220}
      className={`border-4 rounded-lg shadow-lg ml-[40%] transform transition-all duration-1000 ease-out ${
      isIntersecting 
      ...
      <Image
        ...
        width={300}
        height={220}
        className={`border-4 absolute bottom-[50%] left-[-10%] rounded-lg shadow-lg transform transition-all duration-1000 ease-out ${
      isIntersecting
